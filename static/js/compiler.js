...
async function loadContractTemplate() {
    ...
    const response = await fetch('https://backend-tkq4.onrender.com/api/contract.sol');
...
async function compileContract() {
    ...
    try {
        ...
        const compileResponse = await fetch('https://backend-tkq4.onrender.com/api/compile', {
            method: 'POST',
            headers: {
        ...
        if (result.success) {
            ...
            await fetch("https://backend-tkq4.onrender.com/api/markCompiled", { method: "POST", credentials: "include" });
