// debugger.js - Плагін відладки транзакцій

// Глобальні змінні для дебагера
...
function addTransactionToDebugger(txData) {
    ...
    // Оновлення UI якщо дебагер активний
...
// Додавання виклику функції до стеку
...
// Отримання іконки для типу помилки
